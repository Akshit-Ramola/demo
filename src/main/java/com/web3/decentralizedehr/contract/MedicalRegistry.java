 ...
 * Note: For production, it's recommended to compile the .sol file to .bin and .abi,
 * and use the Web3j CLI: `web3j generate solidity -b MedicalRegistry.bin -a MedicalRegistry.abi -o . -p com.web3.decentralizedehr.contract`
 */
public class MedicalRegistry extends Contract {
    ...
    protected MedicalRegistry(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
    ...
    public RemoteFunctionCall<List> getRecords(String _patient) {
        ...
        return new RemoteFunctionCall<>(function,
                () -> executeRemoteCallSingleValueReturn(function, List.class));
    }
    
    public static MedicalRegistry load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
    ...
    public static class RecordStruct extends org.web3j.abi.datatypes.StaticStruct {
        ...
        public RecordStruct(String ipfsHash, BigInteger timestamp, String recordType) {
            super(new Utf8String(ipfsHash), new org.web3j.abi.datatypes.generated.Uint256(timestamp), new Utf8String(recordType));
